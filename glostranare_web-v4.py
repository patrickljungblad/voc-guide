...
PERMANENT_LIBRARY = {
    ...
    "Spanska nybörjare - v. 36": {
        ...
        "words": [
            ...
            {"svenska": "spela ett instrument", "utlandska": "tocar un instrument"},
...
# CSS för att styla orden i Leitner-boxarna med det valda temat
st.markdown(f"""
<style>
.leitner-card {{
    border-radius: 6px;
...
if not st.session_state.words:
    ...
    with tab3:
        ...
        # Dynamisk knapp-etikett för Dubbelt Enter-flödet
        ...
        with st.form("write_form"):
            # Håll fältet aktivt så att användaren kan trycka Enter igen för att gå vidare till nästa ord
        ...
        # Rätta skrivet svar
        if check_write:
            # Om föregående försök på detta ord var korrekt och eleven trycker på Rätta/Enter igen -> gå till nästa
